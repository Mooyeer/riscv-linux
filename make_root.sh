...
make -C ../buildroot
make ARCH=riscv -j 4 CROSS_COMPILE=riscv64-unknown-linux-gnu- CONFIG_INITRAMFS_SOURCE="../buildroot/output/images/rootfs.cpio"
...
make -C ../boom-template/rocket-chip/riscv-tools/riscv-pk/build
